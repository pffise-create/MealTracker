...
const directions = [
  ...
  { id: "02", name: "Bright Signal", short: "Optimism with a clear next step", className: "bright-signal", accent: "#F04F35", accentSoft: "#FFE0B8", bg: "#FFF8ED", ink: "#17262B", muted: "#6D726E", line: "#F0D9C5", font: "Space Grotesk + DM Sans", icon: "Lucide", image: "User / generated photos", character: "Lively, sunny, adult, and action-oriented.", tradeoff: "Makes the predicted action pop immediately, but bright coral needs restraint around neutral nutrition data." },
];
