...
const directions = [
  { id: "01", name: "Mineral Calm", short: "Precision without pressure", className: "mineral-calm", accent: "#547A82", accentSoft: "#C9DCDE", bg: "#F7F8F6", ink: "#202525", muted: "#6E7A78", line: "#DDE3DF", font: "Plus Jakarta Sans", icon: "Phosphor", image: "Open Food Facts", character: "Credible, clear, reassuring.", tradeoff: "Strongest scanability, but risks feeling like generic clinical wellness software." },
  { id: "02", name: "Electric Blue", short: "Crisp energy on white", className: "electric-blue", accent: "#125BFF", accentSoft: "#DDE8FF", bg: "#FFFFFF", ink: "#12243D", muted: "#66758F", line: "#D8E1F0", font: "Plus Jakarta Sans + DM Sans", icon: "Lucide", image: "User / generated photos", character: "Confident, bright, direct, and unmistakably digital.", tradeoff: "Creates the strongest action contrast, but blue needs to stay out of neutral macro status signals." },
  { id: "03", name: "Lime & Sun", short: "Lime green with yellow warmth", className: "lime-signal", accent: "#A8D92F", accentSoft: "#FFF0A8", bg: "#FCFFF5", ink: "#26321E", muted: "#707866", line: "#E3E8C9", font: "Space Grotesk + DM Sans", icon: "Lucide", image: "User / generated photos", character: "Fresh, optimistic, and high-visibility without feeling childish.", tradeoff: "Feels motivating and ownable, but lime requires dark text and careful contrast on primary actions." },
];
